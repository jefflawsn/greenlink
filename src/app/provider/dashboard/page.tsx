                    ...
                    <Card className="lg:col-span-2">
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                {[
                                    { name: 'Sarah Jenkins', type: 'Heat Pump', loc: 'London SW1', status: 'New' },
                                    { name: 'Mike Ross', type: 'Insulation', loc: 'Bristol BS1', status: 'Contacted' },
                                    { name: 'David Kim', type: 'Solar', loc: 'London E1', status: 'Quoted' },
                                ].map((lead, i) => (
